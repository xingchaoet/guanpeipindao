...
//            fclose($open);
            ...
            echo "<td style='text-align: center'><input style='width:15px;' name='amount1[]' id=\"amount1_$bid\" onmouseover='num_limit();'  type='text' maxlength='1' size='1' value=\"$book_num\" /></td>";
