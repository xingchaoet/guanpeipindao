...
<!--	<script type="text/javascript" src="../scrp/listcheck/query.ztree.exedit-3.5.js"></script>-->
	<SCRIPT type="text/javascript">
		...
		function showMenu_zk() {
			...
			$("#menuContent_zk").css({left:zkOffset.left + "px", top:zkOffset.top + zkObj.outerHeight() + "px"}).slideDown("fast");
			$("body").bind("mousedown", onBodyDown_zk);
			
			var zkidObj = $("#ztfl_zk_id_sel");
			var zkidOffset = $("#ztfl_zk_id_sel").offset();
			$("#menuContent_zk").css({left:zkidOffset.left + "px", top:zkidOffset.top + zkidObj.outerHeight() + "px"}).slideDown("fast");
			$("body").bind("mousedown", onBodyDown_zk);
		}
...
<div class="content_wrap">
	<div class="zTreeDemoBackground left">
		<ul id="zk_ul" class="list">
			<li class="title"><input id="ztfl_zk_id_sel" name="ztfl_zk_id_sel" type="hidden" readonly value="<?php echo @$_REQUEST["ztfl_zk_id_sel"]?>" style="width:1px;" /><input id="ztfl_zk_sel"  name="ztfl_zk_sel" value="<?php echo @$_REQUEST["ztfl_zk_sel"]?>" type="text" readonly value="" style="width:208px;" onclick="showMenu_zk();" />
