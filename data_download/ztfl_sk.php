...
<HEAD>
    ...
    <SCRIPT type="text/javascript">
        ...
        function showMenu_sk() {
            ...
            $("#menuContent_sk").css({
                left: skOffset.left + "px",
                top: skOffset.top + skObj.outerHeight() + "px"
            }).slideDown("fast");
            ...
            $("#menuContent_sk").css({
                left: skidOffset.left + "px",
                top: skidOffset.top + skidObj.outerHeight() + "px"
            }).slideDown("fast");
...
//    $ms_tsfl3 = new con_mysql2();
    ...
    while ($tsfl_data3 = odbc_fetch_array($rs_tsfl3)) {
        $zNodes3 = $zNodes3 . "{id:" . trim($tsfl_data3['cat_id']) . ", pId:" . trim($tsfl_data3['parent_id']) . ", name:'" . trim(iconv('gbk', 'utf-8//IGNORE',$tsfl_data3['cat_name'])) . "'";
        if ($ztflsk != '') {
            if (in_array($tsfl_data3[0], $ztflsk)) {
                $zNodes3 .= ", checked:true";
            }
...
<div class="content_wrap">
    <div class="zTreeDemoBackground left">
        <ul id="sk_ul" class="list">
            <li class="title"><input id="ztfl_sk_id_sel" name="ztfl_sk_id_sel" type="hidden" readonly
                                     value="<?php echo @$_REQUEST["ztfl_sk_id_sel"] ?>" style="width:1px;"/><input
                    id="ztfl_sk_sel" name="ztfl_sk_sel" type="text" readonly
                    value="<?php echo @$_REQUEST["ztfl_sk_sel"] ?>" style="width:208px;" onclick="showMenu_sk();"/>
