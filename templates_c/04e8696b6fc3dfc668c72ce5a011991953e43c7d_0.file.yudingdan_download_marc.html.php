...
function content_583e450c8194c8_86005367 ($_smarty_tpl) {
?>
<div id="yudingdan_marc" >
    ...
    <input id="MARC_YDD" type="checkbox" name="MARC_YDD" value="T"/><span class="label label-warning">国图</span>
    <input id="Calis_YDD" type="checkbox" name="Calis_YDD" value="T"/><span class="label label-info">Calis</span>
    <input id="CF_YDD" type="checkbox" name="CF_YDD" value="T"/><span class="label label-success">采访</span>

</div>
<p>
<h2><a id="<?php echo $_smarty_tpl->tpl_vars['sheet_no']->value;?>
"  class="download_yudingdan download_marc_btn btn btn-warning">下载</a></h2>
